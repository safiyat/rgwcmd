...
class AdminUtils(object):
    ...
    def create_user(uid, display_name, email=None, key_type='s3',
        ...
        endpoint = '/admin/user'
        return init_connection().request_ok(method='PUT', endpoint=endpoint,
    ...
    def update_user(uid, display_name=None, email=None, key_type='s3',
        ...
        endpoint = '/admin/user'
        return init_connection().request_ok(method='POST', endpoint=endpoint,
                                            uid=uid, display_name=display_name,
                                            key_type=key_type, email=email,
                                            access_key=access_key,
                                            secret_key=secret_key,
    ...
    def info_user(uid):
        """Delete a user."""
        endpoint = '/admin/user'
        return init_connection().request_ok(method='GET', endpoint=endpoint,
                                            uid=uid)
